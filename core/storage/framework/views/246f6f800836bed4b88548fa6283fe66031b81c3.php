...
<tr id="product-bulk-delete">
  <td><input type="checkbox" class="bulk-item" value="<?php echo e($data->id); ?>"></td>
    <td>
        <img src="<?php echo e($data->thumbnail ? asset('assets/images/featuredimage/'.$data->thumbnail) : asset('assets/images/placeholder.png')); ?>" alt="Image Not Found">
    </td>
    <td>
...
<?php /**PATH /opt/lampp/htdocs/timesquartz/core/resources/views/back/item/table.blade.php ENDPATH**/ ?>