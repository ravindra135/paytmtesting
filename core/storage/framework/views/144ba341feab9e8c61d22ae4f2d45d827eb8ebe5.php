      ...
      <div class="col-xl-9 col-lg-8">
        <div class="steps flex-sm-nowrap mb-5"> 
          ...
          <?php else: ?>
           ...
           <a class="step" href="<?php echo e(route('front.guest_checkout.billing')); ?>">
        ...
        <div class="row padding-top-1x  mb-4">
          <div class="col-sm-6">
            ...
            <ul class="list-unstyled">
              <li><span class="text-muted">Customer Name: </span><?php echo e($ship['ship_first_name']); ?> -<?php echo e($ship['ship_last_name']); ?></li>
              <?php if(PriceHelper::CheckDigital()): ?>
              <li><span class="text-muted"><?php echo e(__('Address')); ?>: </span><?php echo e($ship['ship_address1']); ?> <?php echo e($ship['ship_address2']); ?>, <?php echo e($ship['ship_zip']); ?>, <?php echo e($ship['ship_city']); ?></li>
              <?php endif; ?>
          ...
          <div class="col-sm-6">
            ...
            <ul class="list-unstyled">
              <li><span class="text-muted">Customer Name:: </span><?php echo e($bill['bill_first_name']); ?> <?php echo e($bill['bill_last_name']); ?></li>
              <?php if(PriceHelper::CheckDigital()): ?>
              <li><span class="text-muted"><?php echo e(__('Address')); ?>: </span><?php echo e($bill['bill_address1']); ?> <?php echo e($bill['bill_address2']); ?>, <?php echo e($bill['bill_zip']); ?>, <?php echo e($bill['bill_city']); ?></li>
              <?php endif; ?>
...
<?php echo $__env->make('master.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/timesquartz/core/resources/views/front/checkout/payment.blade.php ENDPATH**/ ?>