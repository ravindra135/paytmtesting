                                                        ...
                                                        <div class="tab-content">
                                                            ...
                                                            <div class="row justify-content-center">
                                                                ...
                                                                <div class="col-lg-12">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label for="footer_address"><?php echo e(__('Office Address')); ?> *</label>
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label for="footer_phone"><?php echo e(__('Toll Free Number')); ?> *</label>
                                                                            <input type="text" name="footer_phone" class="form-control" id="footer_phone"
                                                                                placeholder="<?php echo e(__('Toll Free Number')); ?>" value="<?php echo e($setting->footer_phone); ?>" >
                                                                        </div>

 <div class="form-group">
                                                                            <label for="support_phone"><?php echo e(__('Support Number')); ?> *</label>
                                                                            <input type="text" name="support_phone" class="form-control" id="support_phone"
                                                                                placeholder="<?php echo e(__('Support  Number')); ?>" value="<?php echo e($setting->support_phone); ?>" >
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label for="footer_email"><?php echo e(__('Email')); ?> *</label>
...
<?php echo $__env->make('master.back', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/timesquartz/core/resources/views/back/settings/system.blade.php ENDPATH**/ ?>