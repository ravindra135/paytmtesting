                    ...
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <span class="text-muted"><?php echo e(__('Order Id :')); ?></span><?php echo e($order->orderNumber); ?><br>
                            ...
                            <div class="row">
                                <div class="col-12 col-md-6">
                                      <h5><?php echo e(__('Billing Address :')); ?></h5>
                                          ...
                                          <span class="text-muted">Customer Name: </span><?php echo e($bill['bill_first_name']); ?>-<?php echo e($bill['bill_last_name']); ?><br>
                                ...
                                <div class="col-12 col-md-6">
                                  <h5><?php echo e(__('Shipping Address :')); ?></h5>
                                      ...
                                      ?>
                                          <span class="text-muted">Customer Name:: </span><?php echo e($ship['ship_first_name']); ?> -<?php echo e($ship['ship_last_name']); ?> <br>
                            ...
                            <div class="row">
                                ...
                                <div class="gd-responsive-table">
                                    ...
                                    <tr>
                                        <td class="px-0">
                                            <a target="_blank" href="<?php echo e(url('product')); ?>/<?php echo e($item['slug']); ?>"><?php echo e($item['name']); ?></a>
                                        </td>
                                        <td class="px-0">
...
<?php echo $__env->make('master.back', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/timesquartz/core/resources/views/back/order/invoice.blade.php ENDPATH**/ ?>