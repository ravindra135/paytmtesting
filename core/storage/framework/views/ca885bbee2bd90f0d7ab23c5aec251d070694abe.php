        ...
        <div class="col-lg-8">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="details">Specification *</label>
                        <textarea name="specification" id="specification"
                            class="form-control text-editor"
                            rows="4"
                            placeholder="<?php echo e(__('Enter Specification of the Product')); ?>"
                            ><?php echo e(old('specification')); ?></textarea>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="form-group">
                        <label for="tags"><?php echo e(__('Product Tags')); ?>
                            ...
                            id="tags" placeholder="<?php echo e(__('Tags')); ?>"
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" id="previous_price"
                                ...
                                placeholder="<?php echo e(__('Enter MRP ')); ?>"
                                min="1" step="0.1"
                                value="<?php echo e(old('previous_price')); ?>" >
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="discount_price"><?php echo e(__('Selling Price')); ?>
...
<?php echo $__env->make('master.back', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/timesquartz/core/resources/views/back/item/create.blade.php ENDPATH**/ ?>