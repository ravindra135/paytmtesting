					...
					<div class="row justify-content-center">
						<div class="col-lg-12">
								<form class="admin-form" action="<?php echo e(route('back.brand.update',$brand->id)); ?>"
									...
									<div class="form-group">
										<label for="slug"><?php echo e(__('URL')); ?> *</label>
										<input type="text" name="url" class="form-control" id="url"
											placeholder="<?php echo e(__('Enter URL')); ?>" value="<?php echo e($brand->url); ?>">
									</div>
...
<?php echo $__env->make('master.back', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/core/resources/views/back/brand/edit.blade.php ENDPATH**/ ?>