...
<div class="card table_times_s">
                            <table class="table table-bordered mb-0">
                                ...
                                <tr>
                                    <td data-label="Subject"><?php echo e($ticket->subject); ?></td>
                                    <td data-label="Status">
                                        <span class="badge badge-primary"><?php echo e($ticket->status); ?></span>
                                    </td>
                                    <?php if($ticket->lastMessage): ?>
                                    <td data-label="Last Reply"><?php echo e(\Carbon\Carbon::parse($ticket->lastMessage->created_at)->diffForHumans()); ?></td>
                                    <?php else: ?>
                                    <td> <?php echo e(__('No Reply')); ?></td>
                                    <?php endif; ?>
                                    <td data-label="Action">
                                        <a style="color:white !important" class="btn btn-info btn-sm" href="<?php echo e(route('user.ticket.view',$ticket->id)); ?>">
                                            <i class="fas fa-eye"> </i> <?php echo e(__('View')); ?>

                                        </a>
                                        <a style="color:white !important" class="btn btn-sm btn-primary" href="<?php echo e(route('user.ticket.delete',$ticket->id)); ?>">
...
<?php echo $__env->make('master.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/core/resources/views/user/dashboard/ticket.blade.php ENDPATH**/ ?>