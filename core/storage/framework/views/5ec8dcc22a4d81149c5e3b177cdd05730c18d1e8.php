    ...
    <td>
        <div class="dropdown">
            ...
            <div class="dropdown-menu animated--fade-in" aria-labelledby="dropdownMenuButton">
              ...
              <a class="dropdown-item" data-toggle="modal" data-target="#statusModal" href="javascript:;" data-href="<?php echo e(route('back.order.status',[$data->id,'order_status','In Progress'])); ?>"><?php echo e(__('In Progress- ShipRocket')); ?></a>
...
<?php /**PATH /opt/lampp/htdocs/timesquartz/core/resources/views/back/order/table.blade.php ENDPATH**/ ?>