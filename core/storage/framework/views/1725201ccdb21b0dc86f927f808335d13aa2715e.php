  ...
  <div class="marginooooo">
    <div class="hero-area3">
      <div class="heroarea-slider owl-carousel"> 
        ...
        <div class="item tttttt" style="background: url('<?php echo e(asset('assets/images/' . $slider->logo)); ?>')">
...
</div><?php /**PATH /var/www/html/core/resources/views/front/common/slider.blade.php ENDPATH**/ ?>