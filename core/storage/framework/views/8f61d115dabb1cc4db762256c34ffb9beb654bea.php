               ...
               <nav class="menu">
                 ...
                 <ul class="menu-section">
                   ...
                   <li class="menu-item-has-children">
                     ...
                     <div class="menu-subs menu-mega menu-column-4"> <?php $categories = App\Models\Category::with('subcategory')->whereStatus(1)->orderby('serial','asc')->take(8)->get(); ?> <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $pcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <div class="list-item text-center">
                   ...
                   <li>
                     <div class="header-item-right hidden-md-down">
                       ...
                       <a title="Wishlist" href="<?php echo e(route('user.wishlist.index')); ?>" class="menu-icon menu-icon">
                         ...
                         <span class="count-label cart_count wishlist_count"><?php echo e(Session::has('cart') ? count(Session::get('cart')) : '0'); ?></span>
                       </a>
                       <!-- homepage icon menu -->
...
<div class="header-item-left2">
       ...
       </header><?php /**PATH /var/www/html/core/resources/views/front/common/header.blade.php ENDPATH**/ ?>