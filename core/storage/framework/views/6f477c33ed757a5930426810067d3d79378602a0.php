            ...
            <form class="card" method="post" action="<?php echo e(route('user.login.submit')); ?>">
              ...
              <div class="card-body login_form">
                ...
                <div class="form-group input-group">
                  <input required class="form-control" type="email" name="login_email" placeholder="<?php echo e(__('Email')); ?>" value="<?php echo e(old('login_email')); ?>"><span class="input-group-addon"><i class="icon-mail"></i></span>
                </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group input-group">
                  <input required class="form-control" type="password" name="login_password" placeholder="<?php echo e(__('Password')); ?>" ><span class="input-group-addon"><i class="icon-lock"></i></span>
                </div>
...
<a class="navi-link registe" href="<?php echo e(url('user/register')); ?>"><b><i class="icon-user"></i> Register Now</b></a>
...
<?php echo $__env->make('master.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/timesquartzold/core/resources/views/user/auth/login.blade.php ENDPATH**/ ?>