						...
						<div class="col-lg-12">
								<form class="admin-form" action="<?php echo e(route('back.slider.update',$slider->id)); ?>"
									...
									<div class="form-group">
										<label id="change_label" for="name"><?php echo e($slider->home_page == 'theme3' || $slider->home_page == 'theme4' ? __('Mobile Slider') : __('Logo')); ?></label>
										<br>
											<img class="admin-img"
...
<div class="form-group">
										<label id="slider_text" for="name"><?php echo e($slider->home_page == 'theme3' || $slider->home_page == 'theme4' ? __('Laptop Slider') :__('Laptop Slider')); ?> *</label>
										<br>
											<img class="admin-img"
...
<?php echo $__env->make('master.back', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/timesquartz/core/resources/views/back/slider/edit.blade.php ENDPATH**/ ?>