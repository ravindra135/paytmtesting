  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12" id="type_product_view">
        <div class="row"> <?php $__currentLoopData = $featured->orderBy('id','ASC')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <div class="slider-item col-sm-6 col-xs-6  col-md-3">
            <div class="product-card ">
              <div class="product-thumb"> <?php if(!$item->is_stock()): ?> <div class="product-badge bg-secondary border-default text-body
                  ...
                  <img class="lazy" src="<?php echo e(asset('assets/images/'.$item->thumbnail)); ?>" alt="<?php echo e($item->name); ?>">
                </a>
...
</section><?php /**PATH /var/www/html/core/resources/views/front/common/featured.blade.php ENDPATH**/ ?>