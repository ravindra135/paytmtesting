        ...
        <div class="col-lg-8">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <img class="admin-img lg" src="<?php echo e($item->photo ? asset('assets/images/featuredimage/'.$item->photo) : asset('assets/images/placeholder.png')); ?>" >
                    </div>
                            ...
                            <div class="d-block gallery_image_view">
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $item->galleries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gallery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <div class="single-g-item d-inline-block m-2">
                                            ...
                                            <a class="popup-link" href="<?php echo e($gallery->photo ? asset('assets/images/gallery/'.$gallery->photo) : asset('assets/images/placeholder.png')); ?>">
                                                <img class="admin-gallery-img" src="<?php echo e($gallery->photo ? asset('assets/images/gallery/'.$gallery->photo) : asset('assets/images/placeholder.png')); ?>"
                                                    alt="No Image Found">
                                            </a>
                                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="details">Specifications *</label>
                        <textarea name="specification" id="specification"
                            class="form-control text-editor"
                            rows="4"
                            placeholder="<?php echo e(__('Enter Specifications of the Product')); ?>"
                            ><?php echo e($item->specification); ?></textarea>
                    </div>
                </div>
            </div>
            <div class="card">
                     ...
                     <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" id="previous_price"
                                ...
                                placeholder="<?php echo e(__('Enter Product MRP')); ?>"
                                min="1" step="0.1"
                                value="<?php echo e(round($item->previous_price*$curr->value ,2)); ?>" >
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="discount_price">Selling Price
                            *</label>
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span
...
<?php echo $__env->make('master.back', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/timesquartz/core/resources/views/back/item/edit.blade.php ENDPATH**/ ?>