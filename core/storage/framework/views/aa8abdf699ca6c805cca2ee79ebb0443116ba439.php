...
<!--<div class="col-md-10 offset-md-1"> -->
      ...
      <div class="col-xl-9 col-lg-8">
        <div class="steps flex-sm-nowrap mb-3"><a class="step active" href="<?php echo e(route('front.checkout.billing')); ?>">
        ...
        <div class="card">
            <div class="card-body">
                <?php if(!Auth::user()): ?>
<p class="mb-3">Have an account?   <a href="<?php echo e('/user/login'); ?>"><b>Log in</b></a> 
 <br/></p>
                <?php endif; ?>
        ...
        <div class="row">
          ...
          <div class="col-sm-6">
            <div class="form-group">
              ...
              <input class="form-control" name="bill_phone" type="phone" id="checkout-phone" maxlength="10" pattern="\d{10}" title="Please enter exactly 10 digits phone number" required value="<?php echo e(isset($user) ? $user->phone : ''); ?>">
            </div>
          </div>
        </div>
 ...
 <label for="checkout-zip"><?php echo e(__('Pin Code')); ?></label>
              <input class="form-control" name="bill_zip" type="phone" id="checkout-zip" maxlength="6" pattern="\d{06}" title="Please enter exactly 6 digits PIN Code" required value="<?php echo e(isset($user) ? $user->bill_zip : ''); ?>">
...
<?php echo $__env->make('master.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/timesquartz/core/resources/views/front/checkout/billing.blade.php ENDPATH**/ ?>