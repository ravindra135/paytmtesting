              ...
              <table class="table table-bordered mb-0">
                ...
                <tr>
                    <td data-label="Product">
                      <div class="product-item"><a class="product-thumb" href="<?php echo e(route('front.product',$product->slug)); ?>"><img src="<?php echo e(asset('assets/images/featuredimage/'.$product->photo)); ?>" alt="Product"></a>
...
<?php echo $__env->make('master.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/timesquartz/core/resources/views/user/wishlist/index.blade.php ENDPATH**/ ?>