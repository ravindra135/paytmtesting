...
<div class="card table_times_s">
          ...
          <table class="table table-striped mb-0">
            ...
            <tbody>
             ...
             <tr>
              <td data-label="Order"><a class="navi-link" href="#" data-toggle="modal" data-target="#orderDetails"><?php echo e($order->orderNumber); ?></a></td>
              <td data-label="Total">
...
<?php echo $__env->make('master.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/timesquartz/core/resources/views/user/order/index.blade.php ENDPATH**/ ?>