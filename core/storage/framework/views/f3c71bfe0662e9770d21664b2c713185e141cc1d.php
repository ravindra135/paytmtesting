              ...
              <tbody id="cart_view_load" data-target="<?php echo e(route('cart.get.load')); ?>">
                ...
                <tr>
                    <td class="" data-label="Product Name">
                     ...
                     <img width="60px" src="<?php echo e(asset('assets/images/'.$item['photo'])); ?>" alt="Product">
...
</div><?php /**PATH /var/www/html/core/resources/views/includes/cart.blade.php ENDPATH**/ ?>