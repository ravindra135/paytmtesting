<div class="col-xl-3 col-lg-4">
    <aside class="sidebar">
      ...
      <section class="card widget widget-featured-posts widget-featured-products p-4">
        ...
        <div class="entry">
          <div class="entry-thumb"><a href="<?php echo e(route('front.product',$item['slug'])); ?>"><img src="<?php echo e(asset('assets/images/featuredimage/'.$item['photo'])); ?>" alt="Product"></a></div>
...
<?php /**PATH /opt/lampp/htdocs/timesquartz/core/resources/views/includes/checkout_sitebar.blade.php ENDPATH**/ ?>