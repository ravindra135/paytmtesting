...
class ItemRepository
{
    ...
    public function store($request)
    {
        ...
        if ($file = $request->file('photo')) {
            $images_name = ImageHelper::ItemhandleUploadedImage($request->file('photo'),'assets/images/featuredimage/');
       //  $images_name = Storage::disk('s3')->put('images/featured', $request->photo);
       // $images_name = Storage::disk('s3')->url($images_name);
    ...
    public function update($item,$request)
    {
        ...
        if ( $request->file('photo')) {
            ...
            $images_name = ImageHelper::ItemhandleUpdatedUploadedImage($request->photo,'/assets/images/featuredimage/',$item,'/assets/images/','photo');
            $input['photo'] = $images_name[0];
            $input['thumbnail'] = $images_name[1];
        }
    ...
    public function delete($item)
    {
        ...
        ImageHelper::handleDeletedImage($item,'photo','assets/images/featuredimage/');
        ImageHelper::handleDeletedImage($item,'thumbnail','assets/images/featuredimage/');
    ...
    {
        ImageHelper::handleDeletedImage($gallery,'photo','/assets/images/gallery/');
        $gallery->delete();
    }
    ...
    public function storeImageData($request,$item_id=null)
    {
        ...
        if ($galleries = $request->file('galleries')) {
            foreach($galleries as $key => $gallery){
                $storeData[$key] = [
                    'photo'=>  ImageHelper::handleUploadedImage($gallery,'assets/images/gallery/'),
