...
class Item extends Model
{
    ...
    protected $fillable = ['category_id','subcategory_id','childcategory_id','brand_id','name','slug','sku','tags','video','sort_details','specification','details','photo','thumbnail','discount_price','previous_price','stock','meta_keywords','meta_description','status','is_type','date','item_type','file','link','file_type','license_name','license_key','affiliate_link'];
