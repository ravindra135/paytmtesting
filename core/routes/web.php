    ...
    Route::prefix('admin')->group(function () {
        ...
        Route::group(['middleware' => 'permissions:Manage Orders'], function () {
            ...
            Route::get('/order/invoice/{id}', 'Back\OrderController@invoice')->name('back.order.invoice');
              ...
              Route::get('/order/cancellation_return/userend', 'Back\OrderController@cancellation_return')->name('back.order.cancellation_return');
            Route::get('/order/status/{id}/{field}/{value}', 'Back\OrderController@status')->name('back.order.status');

                        Route::delete('/order/cancellation_return/delete/{id}', 'Back\OrderController@cancellation_return_delete')->name('back.order.cancellation_return_delete');
    ...
    Route::group(['middleware' => 'localize'], function () {
        ...
        Route::prefix('user')->group(function () {
           ...
           // Route::get('/profile', 'User\AccountController@profile')->name('user.profile');
            ...
            //------------ SETTING ------------
            Route::post('/profile/updateprofile', 'User\AccountController@profileUpdate')->name('user.profile.update');
            ...
            Route::get('/order/cancel/{id}/', 'User\OrderController@cancel')->name('user.order.cancel');
             Route::post('/order/cancel', 'User\OrderController@submit_cancel')->name('user.order.submit_cancel');

             Route::get('/order/return/{id}/', 'User\OrderController@return')->name('user.order.return');
             Route::post('/order/return', 'User\OrderController@submit_return')->name('user.order.submit_return');
            //------------ WISHLIST ------------
        ...
        Route::get('/times-tvc', 'Front\FrontendController@tvc')->name('front.tvc');
        ...
        Route::get('/guest-checkout/billing/address', 'Front\CheckoutController@guest_checkout')->name('front.guest_checkout.billing');
        ...
        Route::post('/paytm/notify', 'Payment\PaytmController@notify')->name('front.paytm.notif');
...
Route::get('/ok/clear-cache', function () {
   ...
   return "Cache cleared successfully";
        ...
        Route::get('test/image-upload', 'Front\ImageController@index')->name('image.index');
        Route::post('test/image-upload', 'Front\ImageController@upload')->name('image.upload');
