        ...
        <div class="col-lg-8">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <img class="admin-img lg" src="{{ $item->photo ? asset('assets/images/featuredimage/'.$item->photo) : asset('assets/images/placeholder.png') }}" >
                    </div>
                            ...
                            <div class="d-block gallery_image_view">
                                ...
                                @forelse($item->galleries as $gallery)
                                    <div class="single-g-item d-inline-block m-2">
                                            ...
                                            <a class="popup-link" href="{{ $gallery->photo ? asset('assets/images/gallery/'.$gallery->photo) : asset('assets/images/placeholder.png') }}">
                                                <img class="admin-gallery-img" src="{{ $gallery->photo ? asset('assets/images/gallery/'.$gallery->photo) : asset('assets/images/placeholder.png') }}"
                                                    alt="No Image Found">
                                            </a>
                                    </div>
                                @empty
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="specification" id="specification"
                            class="form-control text-editor"
                            rows="4"
                            placeholder="{{ __('Enter Specifications of the Product') }}"
                     ...
                     <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" id="previous_price"
                                ...
                                placeholder="{{ __('Enter Product MRP') }}"
                                min="1" step="0.1"
