                    ...
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-12 col-md-6">
                                      <h5>{{__('Billing Address :')}}</h5>
                                          ...
                                          <span class="text-muted">Customer Name: </span>{{$bill['bill_first_name']}}-{{$bill['bill_last_name']}}<br>
                                ...
                                <div class="col-12 col-md-6">
                                  <h5>{{__('Shipping Address :')}}</h5>
                                      ...
                                      @endphp
                                          <span class="text-muted">Customer Name:: </span>{{$ship['ship_first_name']}} -{{$ship['ship_last_name']}} <br>
                            ...
                            <div class="row">
                                ...
                                <div class="gd-responsive-table">
                                    ...
                                    <tr>
                                        <td class="px-0">
                                            <a target="_blank" href="{{url('product')}}/{{$item['slug']}}">{{$item['name']}}</a>
                                        </td>
                                        <td class="px-0">
