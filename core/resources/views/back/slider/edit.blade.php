						...
						<div class="col-lg-12">
								<form class="admin-form" action="{{ route('back.slider.update',$slider->id) }}"
									...
									<div class="form-group">
										<label id="change_label" for="name">{{ $slider->home_page == 'theme3' || $slider->home_page == 'theme4' ? __('Mobile Slider') : __('Logo') }}</label>
										<br>
											<img class="admin-img"
...
<div class="form-group">
										<label id="slider_text" for="name">{{ $slider->home_page == 'theme3' || $slider->home_page == 'theme4' ? __('Laptop Slider') :__('Laptop Slider') }} *</label>
										<br>
											<img class="admin-img"
