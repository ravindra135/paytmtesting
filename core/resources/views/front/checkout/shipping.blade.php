        ...
        <div class="row">
          ...
          <div class="col-sm-6">
            <div class="form-group">
              ...
              <input class="form-control" name="ship_phone" type="phone" id="checkout-phone" maxlength="10" pattern="\d{10}" title="Please enter exactly 10 digits phone number" required value="{{isset($user) ? $user->phone : ''}}" >
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-sm-6">
            <div class="form-group">
              ...
              <input class="form-control" name="ship_zip" required type="phone" id="checkout-zip"  maxlength="6" pattern="\d{06}" title="Please enter exactly 6 digits PIN Code" required value="{{isset($user) ? $user->ship_zip : ''}}" >
            </div>
          </div>
          <div class="col-sm-6">
            <div class="form-group">
