      ...
      <div class="col-xl-9 col-lg-8">
        <div class="steps flex-sm-nowrap mb-5"> 
          ...
          @else
           ...
           <a class="step" href="{{route('front.guest_checkout.billing')}}">
        ...
        <div class="row padding-top-1x  mb-4">
          <div class="col-sm-6">
            ...
            <ul class="list-unstyled">
              <li><span class="text-muted">Customer Name: </span>{{$ship['ship_first_name']}} -{{$ship['ship_last_name']}}</li>
              @if (PriceHelper::CheckDigital())
              <li><span class="text-muted">{{__('Address')}}: </span>{{$ship['ship_address1']}} {{$ship['ship_address2']}}, {{$ship['ship_zip']}}, {{$ship['ship_city']}}</li>
              @endif
          ...
          <div class="col-sm-6">
            ...
            <ul class="list-unstyled">
              <li><span class="text-muted">Customer Name:: </span>{{$bill['bill_first_name']}} {{$bill['bill_last_name']}}</li>
              @if (PriceHelper::CheckDigital())
              <li><span class="text-muted">{{__('Address')}}: </span>{{$bill['bill_address1']}} {{$bill['bill_address2']}}, {{$bill['bill_zip']}}, {{$bill['bill_city']}}</li>
              @endif
